...
With the environment variables set, the app will read and write entries to the
Supabase database instead of `localStorage`. Multiple clients will automatically
see updates via Supabase's realtime WebSocket feed.
